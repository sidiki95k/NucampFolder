...
To complete this task i would create many-to-many relationship between the employees and categories
due to the fact that each employee can be an expert in many categories, and each category can have multiple experts.
